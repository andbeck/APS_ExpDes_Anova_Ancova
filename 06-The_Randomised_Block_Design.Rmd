...
In this table, the _INTERCEPT_ is specifying the **FIRST BLOCK** and the **CONTROL** - we know this because it's these words that are missing from the rest of the table, and they are each the first alphanumerially in the list of blocks and treatments.
