...
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{treat }\SpecialCharTok{==} \StringTok{"Placebo"}\NormalTok{) }\SpecialCharTok{*} \DecValTok{1} \SpecialCharTok{+} 
  ...
  \CommentTok{\# block 1 is on average 10 units higher.... and block 5 is now 10 units lower...}
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{block}\SpecialCharTok{==}\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \DecValTok{10} \SpecialCharTok{{-}} 
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{block}\SpecialCharTok{==}\DecValTok{5}\NormalTok{) }\SpecialCharTok{*} \DecValTok{10} \SpecialCharTok{+} 
  \CommentTok{\# now add the error variation}
\NormalTok{  error}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\CommentTok{\# make sure you understand why this is the total unites}
\CommentTok{\# think about the square matrix above....}
...
\CommentTok{\# generate some error}
\NormalTok{error }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(Total.units, }\AttributeTok{mean =} \DecValTok{0}\NormalTok{, }\AttributeTok{sd =} \DecValTok{1}\NormalTok{)}

\CommentTok{\# make sure you think about where we generated variation in the blocking!}
\NormalTok{design}\SpecialCharTok{$}\NormalTok{obs }\OtherTok{\textless{}{-}} \DecValTok{20} \SpecialCharTok{+} 
  \CommentTok{\# the treatment effects}
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{treat}\SpecialCharTok{==}\StringTok{"Herb1"}\NormalTok{) }\SpecialCharTok{*} \DecValTok{10} \SpecialCharTok{+} 
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{treat }\SpecialCharTok{==} \StringTok{"Herb2"}\NormalTok{) }\SpecialCharTok{*} \DecValTok{9} \SpecialCharTok{+}               
  \CommentTok{\# the latin square blocking effects}
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{row}\SpecialCharTok{==}\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \DecValTok{10} \SpecialCharTok{{-}} 
\NormalTok{  (design}\SpecialCharTok{$}\NormalTok{col}\SpecialCharTok{==}\DecValTok{4}\NormalTok{) }\SpecialCharTok{*} \DecValTok{10} \SpecialCharTok{+} 
  \CommentTok{\# the error}
\NormalTok{  error}
...
\NormalTok{Total.units }\OtherTok{\textless{}{-}} \DecValTok{2} \SpecialCharTok{*} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ Nreps }\CommentTok{\# make sure you understand the 2*2 !!}
\NormalTok{error }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(Total.units,}\DecValTok{0}\NormalTok{,}\DecValTok{3}\NormalTok{)}

\CommentTok{\# Here we make to sets of observations {-} obs and obs2}

\CommentTok{\# the data with no interaction (obs)}
\NormalTok{design}\SpecialCharTok{$}\NormalTok{obs }\OtherTok{\textless{}{-}} \DecValTok{20} \SpecialCharTok{{-}} 
...
\CommentTok{\# the data with interaction (obs2)}
...
\NormalTok{  (design}\SpecialCharTok{$}\StringTok{"CO2"} \SpecialCharTok{==} \StringTok{"CO2+"}\NormalTok{) }\SpecialCharTok{*} \DecValTok{9} \SpecialCharTok{+} 
  ...
  \CommentTok{\# this is the interaction.  the effect of UVB now depends on CO2.}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-45-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-54-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-54-2.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-59-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-64-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-73-1.pdf}
...
\includegraphics{Introduction-to-Experimental-Design-and-Analysis_files/figure-latex/unnamed-chunk-78-1.pdf}
