...
\hypersetup{
  pdftitle={An Introduction to Experimental Design},
  pdfauthor={Andrew P Beckerman (based on text from Mark Rees and Gareth Phoenix)},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# use this to make sure the random allocation pattern is the same for you and me}
...
This is like the matrix above, but in tidy format! Excellent.
...
Make sure you think the double-blocking has happened! See the figure above with 4 letters. Can you create the matrix from this design
